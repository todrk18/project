...
<h1 class="text-center">
	<img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">회원정보 수정 <img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">
</h1>
<hr>
...
<hr>
	<form class="text-center" action="modify_save" method="post"> 
		<h2> 변경할 비밀번호를 입력하세요</h2><br>
		아이디 <input type="text" name="userid" value="${nowUser }" readonly="readonly"> <br>
		새로운 비밀번호 <input type="text" name="pass"> <br>
		<input class="text-center btn btn-primary" type="submit" value="회원정보수정">
</hr>
<hr>
		<p class="text-center">
