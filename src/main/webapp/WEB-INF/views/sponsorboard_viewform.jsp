...
<hr>
 ...
 <tr>
             <td style="width: 20%" class="text-center">이미지</td>
             <td style="width: 80%" class="text-center"><img src="<%=request.getContextPath() %>\resources${viewvo.img_url}" width="300"/></td>
 </tr>
 ...
 <tr>
             <td style="width: 10%" class="text-center">단체명</td>
             <td style="width: 80%" class="text-center">${viewvo.group_name}</td>
 </tr>
 <tr>
             <td style="width: 10%" class="text-center">지역</td>
             <td style="width: 80%" class="text-center">${viewvo.area}</td>
 </tr>
 <tr>
             <td style="width: 20%" class="text-center">주소</td>
             <td style="width: 80%" class="text-center">${viewvo.adress}</td>
 </tr>
 <tr>
             <td style="width: 10%" class="text-center">연락처</td>
             <td style="width: 80%" class="text-center">${viewvo.phone_number}</td>
 </tr>
 <tr>
 ...
 <tr>
 		...
 		<h4 class="text-center">
 			<td><a href="modSponsorboard?modno=${viewvo.num}"  class="btn btn-primary" role="button">수정하기
 				<a href="deleteSponsorboard?deltitle=${viewvo.num}"  class="btn btn-primary" role="button">삭제하기</a></td> 
 		</h4>		
</div>
</body>
</html>