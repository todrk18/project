...
<h1 class="text-center">
	<img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">유기동물 등록하기 <img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">
</h1>
<hr>
...
<c:if test="${msg == null }">
	<h2> 유기동물을 등록하세요..</h2>
	<hr>
	<form action="input_findboard_save" method="post" enctype="multipart/form-data" > 
		...
		<div class="inputArea">
 		...
 		잃어버린 장소 <input type="text" name="area"> <br>
