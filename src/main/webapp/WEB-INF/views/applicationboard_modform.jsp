...
<hr>
	...
	<a href="input_applicationboard">[분양신청하기]</a> 
	</h3> 
</hr>
<hr>
<hr>
	...
	<form action="modApplicationboard_pro" method="post" enctype="multipart/form-data">
		...
		지역 <input type="text" name="area" value="${modvo.area }"> <br>
