...
<h1 class="text-center">
	<img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">후원요청글 작성하기 <img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">
</h1>
<hr>
...
<c:if test="${msg == null }">
	<h2> 후원요청을 등록하세요..</h2>
	<hr>
	<form action="input_sponsorboard_save" method="post" enctype="multipart/form-data" > 
		...
		단체명 <input type="text" name="group_name"> <br>
