...
<h1 class="text-center">
	<img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">후원요청 게시판  <img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">
</h1>
<hr>
...
<hr>
	...
	<img src="<%=request.getContextPath() %>/resources/img/강아지3.gif" width="50">
	<a href="input_sponsorboard" class="btn btn-primary btn-lg" role="button">후원요청글 등록</a>  
	<img src="<%=request.getContextPath() %>/resources/img/강아지3.gif" width="50">
	</h3>
</hr>
<hr>
<form class="text-center" action="list_sponsorboard" method="get">
		지역으로 검색<input type="text" name="search_word"><input type="submit" value="검색">	
	</form><br>
 <table class="table table-hover">  
 	<thead>
 		<tr>
 				...
 				<th scope="col" class="text-center">단체명</th>
  ...
  <!--  리스트를 가져옴.. foreach -->
  	<tbody>
	<c:forEach var="sponsorboardvo" items="${sList}" varStatus="status">  <!--  리스트나 배열을 제어하는 명령어 -->
 			<tr>
 				<td style="vertical-align: middle" class="text-center">${status.count}</td>
 				<td style="vertical-align: middle" class="text-center">${sponsorboardvo.num}</td>
 				<td style="vertical-align: middle" class="text-center"><a href="sponsorboard_detail?viewno=${sponsorboardvo.num}"><img src="<%=request.getContextPath() %>\resources${sponsorboardvo.img_thumb }" width="50" /></td>
 				<td style="vertical-align: middle" class="text-center"><a href="sponsorboard_detail?viewno=${sponsorboardvo.num}">${sponsorboardvo.title }</td>
 				<td style="vertical-align: middle" class="text-center">${sponsorboardvo.content}</td>
 				<td style="vertical-align: middle" class="text-center">${sponsorboardvo.group_name}</td>
 				<td style="vertical-align: middle" class="text-center">${sponsorboardvo.area}</td>
 				<td style="vertical-align: middle" class="text-center">${sponsorboardvo.writer}</td>
 				<td style="vertical-align: middle" class="text-center"><fmt:formatDate value="${sponsorboardvo.indate}" pattern="yyyy-MM-dd"/></td>
 				<td style="vertical-align: middle" class="text-center">${sponsorboardvo.cnt}</td>
