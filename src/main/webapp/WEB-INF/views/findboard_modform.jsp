...
<hr>
	...
	<a href="input_findboard" class="btn btn-primary btn-lg" role="button">유기동물 등록</a>  
	</h3>
</hr>
<hr>
<hr>
	...
	<form action="modFindboard_pro" method="post" enctype="multipart/form-data" >
		...
		잃어버린 장소 <input type="text" name="area" value="${modvo.area }"> <br>
