...
<h1 class="text-center">
	<img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">보호동물 등록하기 <img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">
</h1>
<hr>
...
<c:if test="${msg == null }">
	<h2> 보호동물을 등록하세요..</h2>
	<hr>
	<form action="input_protectboard_save" method="post" enctype="multipart/form-data"  > 
		...
		성별 <input type="radio" name="gender" value="수컷">수컷  <input type="radio" name="gender" value="암컷">암컷 <br>
		제목 <input type="text" name="title"> <br>
		내용 <input type="text" name="content"> <br>
		발견 장소 <input type="text" name="discovery_place"> <br>
		발견 날짜 <input type="text" name="discovery_date"> <br>
