...
<hr>
 <table  class="table table-hover">
 	...
 	<h4 class="text-center">
			 <td><a href="modFindboard?modno=${viewvo.num}"  class="btn btn-primary" role="button">수정하기
 				<a href="deleteFindboard?deltitle=${viewvo.num}"  class="btn btn-primary" role="button">삭제하기</a></td> 
 	</h4>			
</div>
</body>
</html>