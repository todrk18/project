...
<hr>
 ...
 <tr>
             <td style="width: 10%" class="text-center">성별</td>
             <td style="width: 80%" class="text-center">${viewvo.gender}</td>
 </tr>
 <tr>
 ...
 <tr>
             <td style="width: 10%" class="text-center">발견장소</td>
             <td style="width: 80%" class="text-center">${viewvo.discovery_place}</td>
 </tr>
 <tr>
             <td style="width: 10%" class="text-center">발견날짜</td>
             <td style="width: 80%" class="text-center">${viewvo.discovery_date}</td>
 </tr>
 <tr>
 ...
 <tr>
 		...
 		<h4 class="text-center">
 				<td><a href="modProtectboard?modno=${viewvo.num}"  class="btn btn-primary" role="button">수정하기
 				<a href="deleteProtectboard?deltitle=${viewvo.num}"  class="btn btn-primary" role="button">삭제하기</a></td> 
 		</h4>		
</div>
</body>
</html>