...
<h1 class="text-center">
	<img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">분양신청  <img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">
</h1>
<hr>
...
<hr>
 ...
 <tr>
             <td style="width: 10%" class="text-center">분양상황</td>
             <td style="width: 80%" class="text-center">${viewvo.parcelout}</td>
 </tr>
 <tr>
 ...
 <tr>
 		...
 		<h4 class="text-center">
 				<td><a href="modApplicationboard?modno=${viewvo.num}"  class="btn btn-primary" role="button">수정하기
 				<a href="deleteApplicationboard?deltitle=${viewvo.num}"  class="btn btn-primary" role="button">삭제하기</a></td>
 		</h4>		 
</div>
</body>
</html>