...
<h1 class="text-center">
	<img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">게시글 작성하기 <img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">
</h1>
<hr>
...
<c:if test="${msg == null }">
	...
	<form action="input_comunityboard_save" method="post" enctype="multipart/form-data" > 
