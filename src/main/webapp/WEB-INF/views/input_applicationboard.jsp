...
<h1 class="text-center">
	<img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">분양신청하기 <img src="<%=request.getContextPath() %>/resources/img/hello.gif" width="100">
</h1>
<hr>
...
<c:if test="${msg == null }">
	...
	<form action="input_applicationboard_save" method="post" enctype="multipart/form-data" > 
		분양상황 <input type="radio" name="parcelout" value="분양합니다!">분양합니다 
				<input type="radio" name="parcelout" value="분양받아요!">분양받아요 <br>
		<div class="inputArea">
		...
		종류 <input type="radio" name="animal_kind" value="강아지">강아지
		    <input type="radio" name="animal_kind" value="고양이">고양이
		    <input type="radio" name="animal_kind" value="기타">기타<br>
		성별 <input type="radio" name="gender" value="수컷">수컷
		    <input type="radio" name="gender" value="암컷">암컷<br>    
		제목 <input type="text" name="title"> <br>
		내용 <input type="text" name="content"> <br>
		작성자 <input type="text" name="writer" value="${nowUser }" readonly="readonly"> <br>
...
<c:if test="${msg == false }">
	<p class="text-center">로그인을 하셔야 글을 작성할 수 있습니다.</p>
	
	<p class="text-center"><a href="/animal" class="btn btn-primary" role="button">홈으로</a></p>
</c:if>	
