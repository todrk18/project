...
<hr>
	...
	<a href="input_protectboard" class="btn btn-primary btn-lg" role="button">보호동물 등록</a>  
	</h3>
</hr>
<hr>
<hr>
	<h2> 정보를 수정 하세요..</h2>
	<!--  일정등록은  날짜, 제목, 업무지시자, 업무배정받을사람,  내용 -->
	<form action="modProtectboard_pro" method="post" enctype="multipart/form-data">
		...
		종류 <input type="text" name="animal_kind" value="${modvo.animal_kind }"> <br>
		성별 <input type="text" name="gender" value="${modvo.gender }"> <br>
		제목 <input type="text" name="title" value="${modvo.title }"> <br>
		내용 <input type="text" name="content" value="${modvo.content }"> <br>
		발견장소 <input type="text" name="discovery_place" value="${modvo.discovery_place }"> <br>
		발견날짜 <input type="text" name="discovery_date" value="${modvo.discovery_date }"> <br>
		작성자 <input type="text" name="writer" value="${modvo.writer }"> <br>
		연락처 <input type="text" name="phone_number" value="${modvo.phone_number }"> <br>
		<input type="hidden" name="num" value="${modvo.num }">	
		삭제글번호: <input type="text" name="test" value="${modvo.num }" readonly><br>
		<hr>
