...
<hr>
	...
	<a href="input_sponsorboard">[후원요청글 등록]</a>
	</h3> 
</hr>
<hr>
<hr>
	...
	<form action="modSponsorboard_pro" method="post" enctype="multipart/form-data">
		...
		단체명 <input type="text" name="group_name" value="${modvo.group_name }"> <br>
		지역 <input type="text" name="area" value="${modvo.area }"> <br>
		주소 <input type="text" name="adress" value="${modvo.adress }"> <br>
